...
\lfoot{\url{http://scesi.fcyt.umss.edu.bo}} \cfoot{\includegraphics[scale=0.022]{gnome/scesi.png}} \rfoot{\thepage/\pageref{LastPage}}
...
\begin{document}
 \begin{titlepage}
	...
	\hrule
	\vspace{0.2cm}
	\noindent\small{\includegraphics[scale=0.06]{gnome/scesi.png} \hfill \includegraphics[scale=0.21]{gnome/memi.jpg}}
%\hrule
\end{titlepage}
