...
\lfoot{\url{http://scesi.fcyt.umss.edu.bo}} \cfoot{\includegraphics[scale=0.25]{img/logo.png}} \rfoot{\thepage/\pageref{LastPage}}
...
\bibitem{GNOME} GNOME Web-Site: \url{http://library.gnome.org/}
\end{thebibliography}
\end{document}
