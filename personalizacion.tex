...
\begin{center}
\includegraphics[scale=0.6]{gnome/acceb1.png} 
\end{center}
\begin{itemize}
\item Ceguera
\begin{description}
...
\item DEFICIENCIAS AUDITIVAS.
\begin{center}
\includegraphics[scale=0.6]{gnome/acceb2.png} 
\end{center}
	\begin{description}
...
\begin{center}
\includegraphics[scale=0.6]{gnome/acceb3.png} 
\end{center}
			\begin{description}
...
\begin{center}
\includegraphics[scale=0.6]{gnome/acceb4.png} 
\end{center}
			\begin{description}
